...
> **소스**: `backend/src/main/java/com/tripcraft/**/controller/*.java` 전수 추출
> **범위**: REST 약 72개 + WebSocket(STOMP) 실시간 협업 채널
> **응답 형식·인증은 코드(`SecurityConfig`, `ApiResponse`, `JwtAuthenticationFilter`)와 1:1 대조**
