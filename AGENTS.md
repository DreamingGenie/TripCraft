...
> **수정 규칙**: 이 파일과 `.Codex/*.md` 파일은 수정 전 반드시 변경 내용을 사용자에게 설명하고 승인을 받을 것.
...
| 작업 도메인 | 참조 파일 |
|------------|----------|
| 회원·인증·보안 | `.Codex/member.md` |
| 관광지 조회·수집 | `.Codex/attraction.md` |
| 여행 일정·이동 시간 | `.Codex/plan.md` |
| 커뮤니티·공지 | `.Codex/community.md` |
